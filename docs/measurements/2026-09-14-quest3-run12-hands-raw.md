...
--- R. Руки и жесты (интерактивная, ADR-0008 фаза 0) ---
  окно rest     трекинг L 100% R 100%; фокус потерян 0, возвращён 0; события: нет
  окно pinch_R  трекинг L 86% R 86%; фокус потерян 3, возвращён 3; события: hi_pinch_R=4, hi_grasp_R=4, aim_pinch_R=4, aim_system_gesture_R=1
  окно pinch_L  трекинг L 100% R 100%; фокус потерян 0, возвращён 0; события: hi_pinch_L=15, hi_grasp_L=13, aim_pinch_L=14, aim_menu_pressed_L=9, aim_menu_gesture_L=10
  окно fist_L   трекинг L 100% R 100%; фокус потерян 0, возвращён 0; события: hi_pinch_L=7, hi_grasp_L=7, aim_pinch_L=1, aim_menu_pressed_L=2, aim_menu_gesture_L=6
  окно poke_R   трекинг L 100% R 100%; фокус потерян 0, возвращён 0; события: hi_pinch_R=6, hi_grasp_R=6, aim_pinch_R=2, aim_system_gesture_R=3, poke_R=7
  окно menu_L   трекинг L 97% R 100%; фокус потерян 0, возвращён 0; события: hi_pinch_L=13, hi_grasp_L=12, aim_pinch_L=12, aim_menu_pressed_L=12, aim_menu_gesture_L=13
  подключены трекеры: ["controller:L", "controller:R", "aim:L", "aim:R"]
  PASS  R контроль: обе руки ведёт профиль /interaction_profiles/ext/hand_interaction_ext — сигналы жестов профиля возможны
  PASS  R трекинг L: данные в 100% кадров окна rest
  PASS  R трекинг R: данные в 100% кадров окна rest
  PASS  R суставы правой: медиана 26 из 26 отслеживаются
  PASS  R фальсификатор: руки видны, жестов нет — все счётчики жестов молчат
  PASS  R щипок правой (профиль рук): 4 нажатий на 3 запрошенных
  PASS  R щипок правой (FB aim): 4 нажатий на 3 запрошенных
  PASS  R щипок левой (профиль рук): 15 нажатий на 3 запрошенных
  PASS  R щипок левой (FB aim): 14 нажатий на 3 запрошенных
  PASS  R кулак левой (grasp_ext): 7 нажатий на 3 запрошенных
  PASS  R тычок правой в шарик: 7 нажатий на 3 запрошенных
  PASS  R жест меню левой приходит в приложение: aim_menu_pressed_L=12, aim_menu_gesture_L=13, hi_pinch_L=13, aim_pinch_L=12; фокус потерян 0 раз
