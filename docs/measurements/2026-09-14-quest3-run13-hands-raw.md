...
цена разогрева PSO, мс:         не измерено
...
бюджет кадра: 11.11 мс при 90.0 Гц — ВСЕ числа ниже относятся к этой частоте
  PASS  частота: запрошена цель 90.0 Гц — получено 90.0 (было 72.0), ждали 38 мс
--- A. Возможности ---
устройство:   Adreno (TM) 740
вендор:       Qualcomm
Vulkan API:   1.3.295
...
--- R v2. Руки: признаки по суставам, визуализация (интерактивная, ADR-0008) ---
пороги классификатора — ЗАГЛУШКИ: сгиб > 0.50, прямой < 0.20, щипок < 0.020 м
  матрица: окно / рука → классы [заглушки] | сырые каналы (без вердикта)
    rest     L  все суставы 100%  fist=0 pinch=0 poke=0 | hi_pinch=0 hi_grasp=0 aim_pinch=0 aim_menu=0
    rest     R  все суставы 100%  fist=0 pinch=0 poke=0 | hi_pinch=0 hi_grasp=0 aim_pinch=0 aim_menu=0
    wrist_L  L  все суставы 100%  fist=0 pinch=0 poke=0 | hi_pinch=0 hi_grasp=0 aim_pinch=0 aim_menu=0
    wrist_L  R  все суставы 100%  fist=0 pinch=0 poke=0 | hi_pinch=0 hi_grasp=0 aim_pinch=0 aim_menu=0
    pinch_R  L  все суставы  92%  fist=0 pinch=0 poke=0 | hi_pinch=0 hi_grasp=0 aim_pinch=0 aim_menu=0
    pinch_R  R  все суставы  92%  fist=0 pinch=2 poke=0 | hi_pinch=2 hi_grasp=0 aim_pinch=1 aim_menu=0
    pinch_L  L  все суставы 100%  fist=0 pinch=6 poke=0 | hi_pinch=5 hi_grasp=4 aim_pinch=5 aim_menu=2
    pinch_L  R  все суставы 100%  fist=0 pinch=0 poke=0 | hi_pinch=0 hi_grasp=0 aim_pinch=0 aim_menu=0
    fist_L   L  все суставы 100%  fist=4 pinch=2 poke=0 | hi_pinch=3 hi_grasp=2 aim_pinch=0 aim_menu=0
    fist_L   R  все суставы 100%  fist=0 pinch=0 poke=0 | hi_pinch=0 hi_grasp=0 aim_pinch=0 aim_menu=0
    poke_R   L  все суставы 100%  fist=0 pinch=0 poke=0 | hi_pinch=0 hi_grasp=0 aim_pinch=0 aim_menu=0
    poke_R   R  все суставы 100%  fist=0 pinch=2 poke=0 | hi_pinch=0 hi_grasp=1 aim_pinch=0 aim_menu=0
  касаний шарика: 3; строк TSV: 12942; сетка руки: { "L": "ready", "R": "ready" }
  PASS  R контроль: обе руки ведёт профиль /interaction_profiles/ext/hand_interaction_ext
  PASS  R трекинг L: все 26 суставов отслеживаются в 100% кадров окна покоя
  PASS  R трекинг R: все 26 суставов отслеживаются в 100% кадров окна покоя
  PASS  R суставы правой: медиана 26 из 26
  PASS  R фальсификатор 1 (покой) [заглушки]: классификатор молчит
  PASS  R фальсификатор 2 (вращение левой кистью) [заглушки]: классификатор молчит
  FAIL  R pinch R [заглушки]: 2 вместо 3 в своём окне
  FAIL  R pinch L [заглушки]: 6 вместо 3 в своём окне
  FAIL  R fist L [заглушки]: 4 вместо 3 в своём окне
  FAIL  R poke R [заглушки]: 0 вместо 3 в своём окне
  PASS  R касания шарика: ровно 3
  FAIL  R перекрёстные срабатывания [заглушки]: fist_L/L:pinch=2, poke_R/R:pinch=2
  PASS  R лог признаков: 12942 строк в /data/data/org.flamti.vrge.probe/files/hands_features.tsv
  PASS  R сетка руки: рантайм отдал модель обеих рук (XR_FB_hand_tracking_mesh)
