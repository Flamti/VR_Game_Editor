...
```
=== ПАСПОРТ ЖЕЛЕЗА ===
ожидается исполненных проверок: 60
...
--- R v3. Руки: жесты по сигналу, ладонь к лицу/от лица (интерактивная, ADR-0008) ---
пороги прогона 13: кулак вход 0.40 / выход 0.24 по min-сгибу; щипок вход 0.0165 / выход 0.030 м при не-кулаке
  срабатывания классификатора по окнам (рука:класс@секунда):
    ...
    pinch_R1 трекинг L 100% R 100%  R:pinch@0.9 R:pinch@1.7 R:pinch@1.7 R:pinch@4.0 R:pinch@4.1 R:pinch@6.4
    pinch_L1 трекинг L 100% R 100%  L:pinch@1.0 L:pinch@3.5 L:pinch@6.5
    pinch_R2 трекинг L 100% R 100%  R:pinch@0.6 R:pinch@3.4 R:pinch@6.4
    pinch_L2 трекинг L 100% R 100%  L:pinch@0.6 L:pinch@3.4 L:pinch@6.4
    pinch_R3 трекинг L 100% R 100%  R:pinch@0.7 R:pinch@3.4 R:pinch@3.5 R:pinch@6.3
    pinch_L3 трекинг L 100% R 100%  L:pinch@0.6 L:pinch@3.4 L:pinch@6.6
    fist_L   трекинг L 100% R 100%  L:fist@0.5 L:fist@3.7 L:fist@6.5 L:fist@9.6
    poke_R   трекинг L 100% R 100%  L:pinch@9.1
  касаний шарика 3; строк TSV 22674; сетка руки { "L": "ready", "R": "ready" }
  ...
  FAIL  R ладонь L: ни один кандидат не разделяет позы — palm_head: к лицу +0.97, от лица +0.91; palm_y_head: к лицу +0.14, от лица +0.16
  PASS  R ладонь R: разделяет palm_head — palm_head: к лицу +0.99, от лица -0.94; palm_y_head: к лицу +0.03, от лица +0.06
  PASS  R свидетель позы левой: menu_gesture горит в 87% кадров «к лицу» и 56% «от лица» — позы выполнены
  FAIL  R pinch R по сигналу: 6 из 9; пропуски []; двойные ["pinch_R1#1×3", "pinch_R1#2×2", "pinch_R3#2×2"]; лишние []
  ...
  FAIL  R перекрёстные срабатывания: poke_R/L:pinch@9.1
  PASS  R лог признаков: 22674 строк
...
passed=51 failed=5 unknown=4
пол: исполнено 60/60 проверок
```
